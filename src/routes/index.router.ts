...
import { APIAccess } from "../services/base.service";
...
export class routes{
    ...
    constructor(router: Router) {
        ...
        router.post("/model/all", APIAccess, this.modelController.GetAll.bind(this.modelController));
    
        router.get("/access/test", APIAccess);
